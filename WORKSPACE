...
maven_install(
    artifacts = [
        ...
        "org.springframework.data:spring-data-rest-core:3.6.3",
        "org.springframework.data:spring-data-rest-hal-explorer:3.6.3",
        "org.springframework.data:spring-data-rest-webmvc:3.6.3",
        "org.springframework:spring-context-indexer:5.3.17",
        ...
        "org.springframework.boot:spring-boot-test-autoconfigure:2.6.5",
        "org.springframework.boot:spring-boot-test:2.6.5",
        "org.springframework:spring-test:5.3.17",
    ]),
    excluded_artifacts = [
